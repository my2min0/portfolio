                        ...
                        <div className="grid grid-cols-2 gap-4 h-full">
                            ...
                            <div className="space-y-4">
                                <ReviewMemo
                                    ...
                                    textColor="#065F46"
                                    name="@천재교육 황OO 멘토님"
                                    review="프로젝트를 하는 내내 리더십 있는 모습으로 다른 사람이 망설이고 있을 때 확실한 방향을 제시하며 임하는 모습이 멋있었습니다. 특히 프론트에 있어서는 화면의 구성과 디자인이 단지 보기 좋은 수준을 넘어, 사용자가 직관적으로 이해할 수 있도록 세심한 설계가 눈에 띄었습니다. 항상 최선을 다하는 모습이 누구보다도 뛰어납니다."
                                />
                                <ReviewMemo
                                    className="bg-[#B9FBC0]"
                                    textColor="#00695C"
