    ...
    return (
        <div className="relative flex flex-col items-center justify-center min-h-screen px-4">
            <div className="max-w-4xl mx-auto text-center">
                ...
                >
                    {/* 첫 번째 레이어 */}
                    <div className="text-white leading-none select-none drop-shadow-md">
                        { renderMainTitle() }
                    </div>

                    {/* 두 번째 레이어 : 마우스 위치에 따라 마스크 효과 적용 */}
                    <div className="absolute top-0 left-0 leading-none transition-opacity duration-300 select-none" style={{ ...hoverTextStyle, color: '#90EE90' }}>
                        { renderMainTitle() }
                    </div>
                </div>
